...
<body>
<form method="post" action="msuDet.rptdo" >
...
<table width="100%" height="550" >
	<tr>
		...
		src="<%=request.getContextPath()%>/metamanage/msu/msuDetTree.jsp"> </iframe></td>
		...
		src="<%=request.getContextPath()%>/msuDet.rptdo"> </iframe></td>
	</tr>
</table>
</form>
</body>
