...
<script type='text/javascript' src='<%=request.getContextPath()%>/dwr/interface/ImpactFlow.js'></script>
...
var msu_id = '<%=msu_id%>';
ImpactFlow.getImpactFlow(msu_id,setFlowXML);//读取流程图数据
...
function menuChanger(contentID,obj){		
	...
	if(contentID==2) {
		...
		obj.href="<%=request.getContextPath()%>/metamanage/msu/sourceFlow.jsp?msu_id="+msu_id;
	}
}
</SCRIPT>
<STYLE>
...
<table width="99" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td><table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="5"><img src="<%=request.getContextPath()%>/images/common/taber/tab_left_off.gif" width="5" height="22"></td>
          <td nowrap class="tab-button-on"><a href="javascript:void(0)" onclick="menuChanger(3,this)" class="tab-button-off-link">影响分析</a></td>
          <td width="5"><img src="<%=request.getContextPath()%>/images/common/taber/tab_right_off.gif" width="5" height="22"></td>
        </tr>
      </table></td>
