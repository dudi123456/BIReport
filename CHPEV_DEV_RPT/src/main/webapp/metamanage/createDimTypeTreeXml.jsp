...
<%
    ...
    Vector result = null;
    try {
        sql.append("select dim_type_id,dim_type_name from UI_META_INFO_DIM_TYPE where parent_id='"+dim_type_id+"'");
    ...
    if (result != null) {
        ...
        Document doc = XMLTranser.transWithXsl(sourcedoc, "createDimTypeTreeXML.xsl");
        // 从服务器端返回目标文档
