...
%>
function pageRedirect_id(tableId) {
	var iframe = document.getElementById("tablelist_frame");
	iframe.src="tableDef.rptdo?table_id="+tableId;
}
</script>
</head>
...
var tree = new WebFXLoadTree("数据表","createTableTreeXML.rptdo?layer_id=-1");
document.write(tree);
