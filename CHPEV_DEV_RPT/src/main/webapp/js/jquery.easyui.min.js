 ...
 * /
 ...
 /**
 *Updated by zhangxianglin
 *Update date:2011-9-8
 */
(function($){
function _1(e){
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"必填项",invalidMessage:null,rules:{email:{validator:function(_2fb){
...
},message:"请输入正确E-mail地址"},url:{validator:function(_2fc){
...
},message:"请输入正确的网址URL"},length:{validator:function(_2fd,_2fe){
