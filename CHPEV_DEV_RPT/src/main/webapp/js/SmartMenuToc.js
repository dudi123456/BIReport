...
{ 
	...
	if (this.toc.browserVersion == 2) { 
		...
		if (this.toc.showIcons)
			this.iconImg = this.layer.document.biimages[this.toc.name +"folderIcon"+this.id] 
		if (this.id>0)
			this.nodeImg = this.layer.document.biimages[this.toc.name +"nodeIcon"+this.id] ;
...
{ 
	...
	if (this.toc.browserVersion == 2) { 		
		...
		this.iconImg = this.layer.document.biimages[this.toc.name + "itemIcon"+this.id] 
		this.toc.currentTopPos=this.toc.currentTopPos+this.layer.clip.height 
	} 
} 
