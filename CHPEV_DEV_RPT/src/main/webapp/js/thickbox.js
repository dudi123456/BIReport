...
var tb_pathToImage = "../biimages/loadingAnimation.gif";
    ...
    try {
        ...
        if (urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp') {//code to show images
            ...
            if (url.indexOf('TB_iframe') != -1) {// either iframe or ajax window            	
                ...
                if (params['keyword'])  urlNoQuery[0] += "keyword=" + params['keyword'];//ck add must remove later......
                $("#TB_iframeContent").remove();
                if (params['modal'] != "true") {//iframe no modal                	
                    $("#TB_window")
							.append(
									"<div id='TB_title'><div id='TB_ajaxWindowTitle'>"
											+ caption + "</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton' title='关闭'>关闭</a></div></div><iframe frameborder='0' hspace='1' src='" + urlNoQuery[0] + "' id='TB_iframeContent' name='TB_iframeContent" + Math.round(Math.random() * 1000) + "' onload='tb_showIframe()' style='width:" + (ajaxContentW + 29) + "px;height:" + (ajaxContentH + 17) + "px;' > </iframe>");
                } else {//iframe modal                	
                    $("#TB_overlay").unbind();
