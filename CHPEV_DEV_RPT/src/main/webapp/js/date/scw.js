...
//******************************************************************************
    ...
    var scwHeadText             = '#ffffff';    // Colour of week headings
    ...
    // Week Numbering
    var scwWeekNumberText       = '#EAEAEA',
        scwWeekNumberBackground = '#967696';

    // Enabled Days

    // Weekend Days
    var scwWeekendText          = '#CC6666',
        scwWeekendBackground    = '#E8F5FD';

    // Days out of current month
    var scwExMonthText          = '#666666',
        scwExMonthBackground    = '#E8F5FD';

    // Current month's weekdays
    var scwCellText             = '#000000',
        scwCellBackground       = '#E8F5FD';
    ...
    var scwDisabledWeekendText          = '#CC6666',
        scwDisabledWeekendBackground    = '#BEBEBE';

    // Days out of current month
    var scwDisabledExMonthText          = '#666666',
        scwDisabledExMonthBackground    = '#BEBEBE';

    // Current month's weekdays
    var scwDisabledCellText             = '#000000',
        scwDisabledCellBackground       = '#BEBEBE';

    // Input date
    var scwDisabledInDateText           = '#FF0000',
        scwDisabledInDateBackground     = '#BEBEBE';
    ...
    document.writeln(   'input.scwHead  {height:21px;width:21px;'              +
	                                    'background-image: url(../biimages/mail_bar_5.gif);'               +
         ...
         if (scwEle.value.length==0)
            ...
            {function scwInputFormat(scwEleValue)
                {var scwArrSeed = new Array(),
                     ...
                     scwArrInput[2] = scwEle.value.substring(6,8);
