...
function _newParam(){	
    ...
    TableQryForm.action="loseSubjectParam.rptdo?optype=add_param_config";
	TableQryForm.submit();
}
...
function _editParam(){	
    ...
    TableQryForm.action="loseSubjectParam.rptdo?optype=update_cch_param_config";
	TableQryForm.submit();
}
...
function _delParam(){	
	...
	if(confirm("确认要删除吗？")){
		TableQryForm.action="loseSubjectParam.rptdo?optype=del_cch_param_config";
		TableQryForm.submit();
	}
}
...
<FORM name="TableQryForm" action="loseSubjectParam.rptdo?optype=cch_param_config"  method="post">
<Tag:Bar />
