...
qryStruct.gather_day_e = DateUtil.getMonthLastDay(qryStruct.gather_month+"01");
...
<table style="width: 100%; margin-top: 0px;" cellspacing="0" cellpadding="0">
	<tr>
		<td  style="padding-left:3px;border-bottom:1px #b3cddd solid;">
			<a id="menu_1" class="tab_act_short" href="javascript:void(0)" onclick="menuChanger(1,1);changeSrc1('1')">趋势分析</a>
		</td>
	</tr>
</table>
...
<table style="width: 100%;" id="content_1" cellspacing="0" cellpadding="0">
	<tr  valign="top" id="add_type_1" >
			...
			<td align="left" valign="top" width="100%"><iframe id="chart_lose_off_ppc_01_C_1" 
						scrolling="no" width="100%" height="255" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>

	</tr>
	<tr>	
	<td align="center" valign="top" width="100%">
			<iframe id="table_lose_off_ppc_01" width="100%" height="170"
							src=""
...
function changeSrc1(rdo){
	var iframe = document.getElementById("table_lose_off_ppc_01");
	tableId = "lose_off_ppc_01";

	iframe.src="SubjectCommTable.rptdo?table_id="+tableId+"&first=Y&table_height=160";

	doChart(rdo);
	var chartIframe = document.getElementById("chart_lose_off_ppc_01_C_1");
	chartIframe.src="SubjectCommChart.screen?chart_id=lose_off_ppc_01_C_1&flag=Y";
}

function doChart(rdo) {
 
	rdoType = rdo;
	document.getElementById("feeTab").innerHTML="<font class='tooltitle'>客户流失>>预付费用户离网预测日分析>>"+tabName[parseInt(tab)-1]+"</font>";
...
function changeChart(tableId,chartId,value,valuedesc){
	...
	checkboxChange('TableQryForm','lose_off_ppc_02_C_1','lose_off_ppc_02_C_1');
...
function export_table_content(){
	...
	window.open("SubjectTableContentExport.screen?table_id="+tableId+"&table_name=预付费用户离网预测日分析-"+tabName[tabT],"数据导出","");
}
