...
<table style="width: 100%;" id="content_1" cellspacing="0" cellpadding="0">
	<tr  valign="top" id="add_type_1" >
		...
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;" border="0">
			...
			<tr valign="top">
			<td align="left" valign="top" width="44%" id="chartIframe" >
			<!-- <iframe id="chart_lose_call_zero_01_C_1" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe>-->
			</td>

			<td align="left" valign="top" width="100%"><iframe id="chart_lose_call_zero_01_C_2" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
	...
	<td>
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">
			<tr valign="top" >
				<td align="left" colspan="2"><iframe id="table_lose_call_zero_01" width="100%" height="300"
							src=""
...
var addTypeLen = 0;
var tableId = "MIFO001";
var title = new Array("在网时长"," ARPU分档 ","产品","销售品"," 主资费");
...
function changeSrc1(rdo){
	var iframe = document.getElementById("table_lose_call_zero_01");
	tableId = "lose_call_zero_01";
...
function doChart(rdo) {
	...
	rdoType = rdo;
	document.getElementById("feeTab").innerHTML="<font class='tooltitle'>客户流失>>连续3月零次通话预警>>"+tabName[parseInt(tab)-1]+"</font>";
...
function changeChart(tableId,chartId,value,valuedesc){
	...
	checkboxChange('TableQryForm','lose_call_zero_01_C_1','lose_call_zero_01_C_1');

}

function typeChange(value) {
	var tableIframe = document.getElementById("table_lose_call_zero_01");    
	tableIframe.src="SubjectCommTable.rptdo?table_id=lose_call_zero_0"+value+"&first=Y&table_height=300";
	var chartIframe = document.getElementById("chartIframe");
	var chartId = "lose_call_zero_0"+value+"_C_1";
	chartIframe.innerHTML="<iframe id='chart_"+chartId+"' scrolling='no' width='100%' height='240' border='0' frameborder='0' "
	+ "src=''"
...
//	var chartIframe = document.getElementById("chart_lose_call_zero_01_C_1");
//	chartIframe.src="SubjectCommChart.screen?chart_id=lose_call_zero_0"+value+"_C_1&flag=Y";
	var chartIframe1 = document.getElementById("chart_lose_call_zero_01_C_2");
	chartIframe1.src="SubjectCommChart.screen?chart_id=lose_call_zero_01_C_2&flag=Y";
	var checkBox = document.getElementsByName("checkboxlose_call_zero_01_C_2"); 
...
function export_table_content(){
	...
	window.open("SubjectTableContentExport.screen?table_id="+tableId+"&table_name=连续3月零次通话预警-"+tabName[tabT],"数据导出","");
}
