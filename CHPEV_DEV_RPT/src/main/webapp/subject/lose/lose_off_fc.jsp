...
qryStruct.date_e = DateUtil.getDiffMonth(2, DateUtil.getNowDate());
%>
...
<table style="width: 100%; margin-top: 0px;" cellspacing="0" cellpadding="0">
	<tr>
		<td  style="padding-left:3px;border-bottom:1px #b3cddd solid;">
			<a id="menu_1" class="tab_short" href="javascript:void(0)" onclick="menuChanger(1,2);changeSrc1('1')">预测分析</a><a id="menu_2" class="tab_short" href="javascript:void(0)" onclick="menuChanger(2,2);changeSrc2('1')">预测评估</a>
		</td>
	</tr>
</table>
...
<table class="popwidow" cellpadding="0" cellspacing="5">
	...
	<tr>
		<td valign="top"><%=PageConditionUtil.getMonthDesc(request)%></td>
...
<table style="width: 100%; display: none;"  id="content_1" cellspacing="0" cellpaddingx="0">
	...
	<td colspan='3'>
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;margin-bottom: 15px;">
			<tr valign="top">
			<td align="left" valign="top" width="85%"><iframe id="chart_lose_off_fc_01_C_1" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>
				
			<td width="15%" ><%=PageConditionUtil.getChartFunction("lose_off_fc_01_C_1","checkbox","1","TableQryForm",5) %></td>	
			</tr>
		</table>
	</td>
	</tr>
	...
	<td>
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">
			<tr valign="top" >
				<td align="left" colspan="2"><iframe id="table_lose_off_fc_01" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>
				</td>
...
<table style="width: 100%; display: none;" id="content_2" cellspacing="0" cellpadding="0">
	<tr  valign="top" id="add_type_2" >
		...
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;margin-bottom: 15px;" border="0">
			<tr  valign="top">
			<td align="left" valign="top" width="85%"><iframe id="chart_lose_off_fc_02_C_1" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>
			<td width="15%" ><%=PageConditionUtil.getChartFunction("lose_off_fc_02_C_1","radio","1","TableQryForm",5) %></td>	
			</tr>
		</table>
	</td>
	</tr>
	...
	<td>
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">
			<tr valign="top" >
				<td align="left" ><iframe id="table_lose_off_fc_02" width="100%" height="300"
							src=""
...
var tabName = new Array("预测分析","预测评估");
...
function changeSrc1(rdo){
	//alert(rdo);
	var iframe = document.getElementById("table_lose_off_fc_01");
	tableId = "lose_off_fc_01";
	iframe.src="SubjectCommTable.rptdo?table_id="+tableId+"&first=Y&table_height=200";
	var chartIframe = document.getElementById("chart_lose_off_fc_01_C_1");
	chartIframe.src="SubjectCommChart.screen?chart_id=lose_off_fc_01_C_1&flag=Y";
	doChart(rdo);

}
function changeSrc2(rdo){
	var iframe = document.getElementById("table_lose_off_fc_02");
	tableId = "lose_off_fc_02";

	iframe.src="SubjectCommTable.rptdo?table_id="+tableId+"&first=Y&table_height=200";

	doChart(rdo);
	var chartIframe = document.getElementById("chart_lose_off_fc_02_C_1");
	chartIframe.src="SubjectCommChart.screen?chart_id=lose_off_fc_02_C_1&flag=Y";
}

function doChart(rdo) {
 
	rdoType = rdo;
	document.getElementById("feeTab").innerHTML="<font class='tooltitle'>客户流失>>离网预测分析>>"+tabName[parseInt(tab)-1]+"</font>";
...
function changeChart(tableId,chartId,value,valuedesc){
	...
	checkboxChange('TableQryForm','lose_off_fc_02_C_1','lose_off_fc_02_C_1');
...
function export_table_content(){
	...
	window.open("SubjectTableContentExport.screen?table_id="+tableId+"&table_name=离网预测分析-"+tabName[tabT],"数据导出","");
}
