...
<table style="width: 100%; margin-top: 0px;" cellspacing="0" cellpadding="0">
	<tr>
		<td  style="padding-left:3px;border-bottom:1px #b3cddd solid;">
			<a id="menu_2" class="tab_short" href="javascript:void(0)" onclick="menuChanger(2,2);changeSrc2('2')">对比分析</a><a id="menu_1" class="tab_short" href="javascript:void(0)" onclick="menuChanger(1,2);changeSrc1('1')">趋势分析</a>
		</td>
	</tr>
</table>
...
<table style="width: 100%;" align="center" cellspacing="0" cellpadding="0">
	<tr class="tools">
		...
		<td title="点击打开条件选择菜单" align="right" onclick="showcat('menucontent')"; style="cursor:pointer">
		  <font class="tooltxt"  title="点击打开条件选择菜单" ><b>在网时长</b>：<span id=city_name><%=qryStruct.online_lvl_desc%></span><INPUT type=hidden name=qry__online_lvl_desc size="10"><INPUT type=hidden name=qry__online_lvl_id></font>
...
<table class="popwidow" cellpadding="0" cellspacing="5">
	<tr>
	    <td class="poptitle" style="width:450px">在网时长</td>
		<td class="poptitle" style="width:110">时间</td>
		<td class="poptitle" style="width:40px">操作</td>
	</tr>
	<tr>
	    <td valign="top"><%=PageConditionUtil.getOnlineLvl(request,qryStruct.online_lvl_id,"online_lvl_id","online_lvl_desc","101",2)%></td>
...
<table style="width: 100%; display: none;"  id="content_1" cellspacing="0" cellpaddingx="0">
	...
	<td colspan='3'>
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;margin-bottom: 15px;">
			<tr valign="top">
			<td align="left" valign="top" width="85%"><iframe id="chart_lose_cust_01_C_1" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>
				
			<td width="15%"><%=PageConditionUtil.getChartFunction("lose_cust_01_C_1","checkbox","1","TableQryForm",5) %></td>	
			</tr>
		</table>
	</td>
	</tr>
	...
	<td>
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">
			<tr valign="top" >
				<td align="left" colspan="2"><iframe id="table_lose_cust_01" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>
				</td>
			</tr>
...
<table style="width: 100%; display: none;" id="content_2" cellspacing="0" cellpadding="0">
		...
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;margin-bottom: 15px;" border="0">
			<tr  valign="top">
			   <td class="toolbg" colspan=3>
			 		类型:
			 		<input type="radio" name="type_id" id="type_id" value="2" onClick="typeChange(this.value)" checked="checked" />在网时长
			 		...
			 		<input type="radio" name="type_id" id="type_id" value="5" onClick="typeChange(this.value)" />资费
	   		   </td>	
		 	</tr>
			<tr valign="top">
			<td align="left" valign="top" width="43%"><iframe id="chart_lose_cust_02_C_1" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>
			<td align="left" valign="top" width="47%"><iframe id="chart_lose_cust_02_C_2" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>				
			<td width="12%"><%=PageConditionUtil.getChartFunction("lose_cust_02_C_2","checkbox","1","TableQryForm",5) %></td>	
			</tr>
		</table>
	</td>
	</tr>
	...
	<td>
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">
			<tr valign="top" >
				<td align="left" colspan="2"><iframe id="table_lose_cust_02" width="100%" height="300"
							src=""
...
var tabName = new Array("趋势分析","对比分析");
...
function changeSrc1(rdo){
	//alert(rdo);
	var iframe = document.getElementById("table_lose_cust_01");
	tableId = "lose_cust_01";
	iframe.src="SubjectCommTable.rptdo?table_id="+tableId+"&first=Y&table_height=300";
	var chartIframe = document.getElementById("chart_lose_cust_01_C_1");
	chartIframe.src="SubjectCommChart.screen?chart_id=lose_cust_01_C_1&flag=Y";	
	doChart(rdo);

}
function changeSrc2(rdo){
	var iframe = document.getElementById("table_lose_cust_02");
	tableId = "lose_cust_02";
...
function doChart(rdo) {
	...
	rdoType = rdo;
	document.getElementById("feeTab").innerHTML="<font class='tooltitle'>客户流失>>已流失客户分析>>"+tabName[parseInt(tab)-1]+"</font>";

}


function seleType2(id,name,ck) {
	var chartIframe = document.getElementById("chart_lose_cust_02_C_1");
	chartIframe.src="SubjectCommChart.screen?chart_id=lose_cust_02_C_1&flag=Y";
	var chartIframe1 = document.getElementById("chart_lose_cust_02_C_2");
	chartIframe1.src="SubjectCommChart.screen?chart_id=lose_cust_02_C_2&flag=Y";
}
...
function changeChart(tableId,chartId,value,valuedesc){
	...
	checkboxChange('TableQryForm','lose_cust_02_C_1','lose_cust_02_C_1');

}

function typeChange(value) {
	var tableIframe = document.getElementById("table_lose_cust_02");    
	tableIframe.src="SubjectCommTable.rptdo?table_id=lose_cust_0"+value+"&first=Y&table_height=300";
	var chartIframe = document.getElementById("chart_lose_cust_02_C_1");
	chartIframe.src="SubjectCommChart.screen?chart_id=lose_cust_0"+value+"_C_1&flag=Y";
	var chartIframe1 = document.getElementById("chart_lose_cust_02_C_2");
	chartIframe1.src="SubjectCommChart.screen?chart_id=lose_cust_02_C_2&flag=Y";
	var checkBox = document.getElementsByName("checkboxlose_cust_02_C_2"); 
...
function export_table_content(){
	...
	window.open("SubjectTableContentExport.screen?table_id="+tableId+"&table_name=已流失客户分析-"+tabName[tabT],"数据导出","");
}
