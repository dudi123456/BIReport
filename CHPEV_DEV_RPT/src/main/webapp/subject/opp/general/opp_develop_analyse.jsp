...
var addTypeLen = 0;
var tableId = "MIFO001";
var title = new Array("占有率分析","发展分析","累计值","累计值同比");
var tabName = new Array("占有率分析","发展分析");
...
*/
	...
	iframe.src="SubjectCommTable.rptdo?table_id="+tableId+"&first=Y&table_height=230";
...
//	linkDiv.innerHTML=sHtml;
	//alert(tab);
	document.getElementById("feeTab").innerHTML="<font class='tooltitle'>专题分析>>竞争对手专题>>竞争宏观分析>>发展分析>>"+tabName[parseInt(tab)-1]+"</font>";
...
function seleType1(id,name,ck) {
	changeAddType(ck);
	var chartIframe = document.getElementById("chart_opp_macro_001_1_C_1");
	chartIframe.src="SubjectCommChart.screen?chart_id=opp_macro_001_1_C_1&carrier_id=10&carrier_name=中国&level=0&chart_name=中国%20";
	chartIframe = document.getElementById("trend_chart_"+tab+"_2");
	chartIframe.src="SubjectCommChart.screen?chart_id=opp_macro_001_1_C_2&whereSql=&data_kind_id="+id+"&chart_name="+name;
...
function seleType2(id,name,ck) {
	...
	for(var i=0; i<radio.length; i++) { 
		...
		if (radio[i].checked)
		{
			chartIframe.src="SubjectCommChart.screen?chart_id=" + radio[i].value;
...
//	chartIframe = document.getElementById("trend_chart_"+tab+"_2");
//	chartIframe.src="SubjectCommChart.screen?chart_id=opp_macro_001_2_C_2&whereSql=&data_kind_id="+id+"&chart_name="+name;
...
<table style="width: 100%; margin-top: 0px;" cellspacing="0" cellpadding="0">
	<tr>
		<td  style="padding-left:3px;border-bottom:1px #b3cddd solid;">
			<a id="menu_1" class="tab_short" href="javascript:void(0)" onclick="menuChanger(1,2);changeSrc1('1')">占有率分析</a><a id="menu_2" class="tab_short" href="javascript:void(0)" onclick="menuChanger(2,2);changeSrc2('1')">发展分析</a>
		</td>
	</tr>
</table>
...
<table style="width: 100%; display: none;"  id="content_1" cellspacing="0" cellpaddingx="0">
	<tr  valign="top" id="add_type_1" >
		...
		<tr  valign="top">
			...
			<tr valign="top">
			<td align="left" valign="top" ><iframe id="chart_opp_macro_001_1_C_1" 
 ...
 -->				
	...
	<td>
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">
			...
			<tr valign="top" >
				<td align="left" colspan="2"><iframe name="table_opp_macro_001_1" id="table_opp_macro_001_1" width="100%" height="250"
							src=""
...
<table style="width: 100%; display: none;" id="content_2" cellspacing="0" cellpadding="0">
	<tr  valign="top" id="add_type_2" >
		...
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;margin-bottom: 15px;">
		<tr  valign="top">
			   <td class="toolbg" colspan=1>
			 		<INPUT class="radioStyle" onclick="changeChart('opp_macro_001_2_C_1');" value="opp_macro_001_2_C_1" type=radio name=Leve6_1 checked>发展用户数
			 		<INPUT class="radioStyle" onclick="changeChart('opp_macro_001_2_C_3');" value="opp_macro_001_2_C_3" type=radio name=Leve6_1>离网用户数
			 		<INPUT class="radioStyle" onclick="changeChart('opp_macro_001_2_C_4');" value="opp_macro_001_2_C_4" type=radio name=Leve6_1>净增用户数
					<INPUT class="radioStyle" onclick="changeChart('opp_macro_001_2_C_2');" value="opp_macro_001_2_C_2" type=radio name=Leve6_1>到达用户数

	   			 </td>	
		 	</tr> 
			<tr valign="top">
			<td width="100%" align="left" valign="top" ><iframe id="trend_chart_2" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>
	...
	<td>
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">
			<tr valign="top" >
				<td align="left" colspan="2"><iframe id="table_list_2" width="100%" height="260"
							src=""
					frameborder="0" scrolling="no"></iframe>
				</td>
			</tr>
...
<table cellspacing="0" cellpaddingx="0" style="width: 100%;">
		...
		<tr>
		<td><%=CommTool.getEditorHtml("opp_develop_analyse","0")%></td>
	</tr>
</table>
