...
//导出
 function export_table_content(param){
	 if("cur" == param){
		 ...
		 TableQryForm.action = "OppStableToExcel.screen";
		 TableQryForm.submit();
		 
	 }else if("all" == param){		 	
			var dimTableStr = baseXmlSubmit.callAction("../subject/SubejctAjax.rptdo?type_id=OPPSUBJECT&res_id=稳定性分析&exportName=竞争对手稳定性分析");
...
<INPUT type=hidden name="resId" value="稳定性分析">

<div style="display:none;position:absolute;" id=altlayer></div>

<table style="width: 100%;" align="center" cellspacing="0" cellpadding="0">
	<tr class="tools">
		<td><font class='tooltitle'>&nbsp;竞争对手专题&nbsp;>>&nbsp;交往圈分析&nbsp;>>&nbsp;竞争对手稳定性分析&nbsp;</font></td><td><a href='javascript:;' onclick="open_metaExplain('SUBJECT')"><img src="<%=request.getContextPath()%>/biimages/home/nav_icon3.gif" width="14" height="14" border="0" hspace="10">指标说明</a></td>
...
<table style="width: 100%"  style="background-color:#F0F0F0;border-top:1px #D8D8E4 solid;">
	<tr>
		<td class="toolbg">稳定性阀值：<BIBM:TagSelectList listID="OPP001" listName="qry__opp_stable_value"  focusID="<%=qryStruct.opp_stable_value%>" />&nbsp;通话次数权重：<input type="text" name="qry__call_times"  style="width:50px;" value=""/> 主叫通话次数权重：<input type="text" name="qry__calling_times"  style="width:50px;" />被叫通话次数权重：<input type="text" name="qry__called_times"  style="width:50px;"/>次均通话时长权重：<input type="text" name="qry__avg_call_dura"  style="width:50px;" />&nbsp;<input type="button"  value="确定" ID="button_submit" onclick="doQuery()"></td>
	</tr>
	<tr>
		<td class="toolbg">展现记录急：<BIBM:TagSelectList listID="OPP002" listName="qry__opp_rownum"  focusID="<%=qryStruct.opp_rownum%>" />&nbsp;通话时长权重：<input type="text" name="qry__call_dura"  style="width:50px;" /> 主叫通话时长权重：<input type="text" name="qry__calling_dura"  style="width:50px;" />被叫通话时长权重：<input type="text" name="qry__called_dura"  style="width:50px;"/>交&nbsp;&nbsp;往&nbsp;&nbsp;圈&nbsp;&nbsp;权重：<input type="text" name="qry__sphere_num"  style="width:50px;"/>&nbsp;<input type="button" id="button_outputExcelMin" onclick="javascript:export_table_content('cur')" value="导出"></td>
	</tr>
...
<div id="oppparamdiv" style="width: 100%; margin-top: 2px; overflow: auto; height:400px;">
               <table style="width: 100%" border="0" bgcolor="#CFCFCF" cellpadding="1" cellspacing="1"
                  ...
                  <tr class="celtitle FixedTitleRow">
                    ...
                    <td align="center"  bgcolor="E3E3E3" width="9%">稳定性系数</td>
                    <td align="center"  bgcolor="E3E3E3" width="9%">通话次数系数</td>                    
                    <td align="center"  bgcolor="E3E3E3" width="9%">主叫次数系数</td>
                    <td align="center"  bgcolor="E3E3E3" width="9%">被叫次数系数</td>
                    <td align="center"  bgcolor="E3E3E3" width="9%">通话时长系数</td>
                    <td align="center"  bgcolor="E3E3E3" width="9%">主叫时长系数</td>
                    <td align="center"  bgcolor="E3E3E3" width="9%">被叫时长系数</td>
                    <td align="center"  bgcolor="E3E3E3" width="9%">次均时长系数</td>
                    <td align="center"  bgcolor="E3E3E3" width="9%">交往圈系数</td>
                  </tr>   
                  
                	  <%
                	  if(value==null||value.length <=0){
                		  out.println("<tr class=\"celdata\" onmouseover=\"this.className='mouseM'\" onmouseout=\"this.className='celdata'\">");
                		  out.println("<td align=\"center\" colspan=\"11\">当前条件没有匹配的竞争对手稳定用户</td>");                		  
                		  out.println("</tr>");
                	  }else{
 ...
 <table cellspacing="0" cellpaddingx="0" style="width: 100%;">
		...
		<tr>
		<td><%=CommTool.getEditorHtml("OppStable","0")%></td>
	</tr>
</table>
