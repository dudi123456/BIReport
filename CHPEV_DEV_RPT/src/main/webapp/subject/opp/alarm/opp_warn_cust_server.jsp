...
var tabName = new Array("外呼客服分布","竞争对手客服趋势");
...
//	linkDiv.innerHTML=sHtml;
	//alert(tab);
	document.getElementById("feeTab").innerHTML="<font class='tooltitle'>专题分析>>竞争对手专题>>竞争预警>>客服预警>>"+tabName[parseInt(tab)-1]+"</font>";
...
function seleType1(id,name,ck) {
	...
	var chartIframe = document.getElementById("chart_opp_warn_002_1_C_2");
	chartIframe.src="SubjectCommChart.screen?chart_id=opp_warn_002_1_C_2&whereSql=&data_kind_id="+id+"&chart_name="+name+"&op_time=<%=qryStruct.gather_month%>";
	var chartIframe2 = document.getElementById("chart_opp_warn_002_1_C_3");
	chartIframe2.src="SubjectCommChart.screen?chart_id=opp_warn_002_1_C_3&whereSql=&data_kind_id="+id+"&chart_name="+name+"&op_time=<%=qryStruct.gather_month%>";
	var chartIframe3 = document.getElementById("chart_opp_warn_002_1_C_4");
	chartIframe3.src="SubjectCommChart.screen?chart_id=opp_warn_002_1_C_4&whereSql=&data_kind_id="+id+"&chart_name="+name+"&op_time=<%=qryStruct.gather_month%>";

//	alert(of.outerHTML);
}
function seleType2(id,name,ck) {

	var chartIframe = document.getElementById("trend_chart_11");    
	chartIframe.src="SubjectCommChart.screen?chart_id=opp_warn_002_2_C_1&whereSql=&data_kind_id="+id+"&chart_name="+name;
	var chartIframe2 = document.getElementById("chart_opp_warn_002_2_C_2");   
	chartIframe2.src="SubjectCommChart.screen?chart_id=opp_warn_002_2_C_2&whereSql=&data_kind_id="+id+"&chart_name="+name+"&op_time=<%=qryStruct.gather_month%>";
}
...
function export_table_content(){
	...
	window.open("SubjectTableContentExport.screen?table_id="+tableId+"&table_name=竞争预警-"+tabName[tabT],"数据导出","");
}
...
<table style="width: 100%; margin-top: 0px;" cellspacing="0" cellpadding="0">
	<tr>
		<td  style="padding-left:3px;border-bottom:1px #b3cddd solid;">
			<a id="menu_1" class="tab_short" href="javascript:void(0)" onclick="menuChanger(1,2);changeSrc1('1')">外呼客服</a><a id="menu_2" class="tab_short" href="javascript:void(0)" onclick="menuChanger(2,2);changeSrc2('1')">竞争对手客服</a>
		</td>
	</tr>
</table>
...
<table style="width: 100%; display: none;"  id="content_1" cellspacing="0" cellpaddingx="0">
	<tr  valign="top"  id="add_type_1" >
		...
		<tr  valign="top">
			...
			<tr valign="top">
			<td align="left" valign="top" ><iframe id="chart_opp_warn_002_1_C_2" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>
			<td align="left" valign="top" ><iframe id="chart_opp_warn_002_1_C_3" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>
			<td align="left" valign="top" ><iframe id="chart_opp_warn_002_1_C_4" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>					
	...
	<td>
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">
			...
			<tr valign="top" >
				<td align="left" colspan="2"><iframe name="table_list_1" id="table_list_1" width="100%" height="300"
							src=""
...
<table style="width: 100%; display: none;" id="content_2" cellspacing="0" cellpadding="0">
	<tr  valign="top"  id="add_type_2" >
		...
		<tr  valign="top">
			...
			<tr valign="top">
			<td align="left" valign="top" ><iframe id="trend_chart_11" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>
			<td align="left" valign="top" ><iframe id="chart_opp_warn_002_2_C_2" 
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>				
			</tr>
		</table>
...
<table cellspacing="0" cellpaddingx="0" style="width: 100%;">
		...
		<tr>
		<td><%=CommTool.getEditorHtml("opp_warn_cust_server","0")%></td>
	</tr>
</table>
