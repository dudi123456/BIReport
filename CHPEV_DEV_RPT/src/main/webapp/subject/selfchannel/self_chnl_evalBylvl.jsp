...
<script>
	...
	function initframe(){
		document.getElementById("chart_self_chnl_C_01_lvl").src="SubjectCommChart.screen?chart_id=self_chnl_C_01_lvl";
		document.getElementById("table_self_chnl_T_01_lvl").src="SubjectCommTable.rptdo?table_id=self_chnl_T_01_lvl&first=Y&setParentHight=N&table_height=250&with_bar=N";		
	}
...
<div class="topsearch">
	 <table width="80%"  cellpadding="0" cellspacing="0" align="center">
                  <tr>
                  <td align="right" class="td-bg" nowrap="nowrap">月份：</td>
                    <td >
                   ...
                   <!-- 
                  	<td align="right" class="td-bg" nowrap="nowrap">考核区域：</td>
                    <td >
                    ...
                    --> 	
                    <td align="right" class="td-bg" nowrap="nowrap">省分：</td>
                    <td >
                    ...
                    <td align="right" class="td-bg" nowrap="nowrap">地市：</td>
            		<td >
	...
	<tr>
		...
		<td>
			<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">
				<tr valign="top" >
				  <td align="left" colspan="2"><iframe id="table_self_chnl_T_01_lvl" width="100%" height="250" src="" frameborder="0" scrolling="no"></iframe></td>
				</tr>
			</table>
		</td>
		
		<td align="left" valign="top" >
			<iframe id="chart_self_chnl_C_01_lvl" scrolling="no" width="100%" height="220" border="0" frameborder="0" marginwidth="0" marginheight="0" src=""></iframe>
		</td>
