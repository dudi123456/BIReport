...
<%=WebPageTool.pageScript("TableQryForm","Show_ShortMsgComm.screen")%>
<% 
        ...
        <table width="100%" border="0">
          <tr>
			  ...
			  <td>资费名称:<BIBM:TagSelectList listName="qry__dim3"
									...
									selfSQL="select x.price_plan_id,x.price_plan_name from new_bi_ui.d_adv_focus_pp x where x.price_plan_cat_id=1 order by price_plan_id" /></td>
