...
<table style="width: 100%;" align="center" cellspacing="0" cellpadding="0">
	<tr class="tools">
		<td><font class="tooltitle">专题分析>>增值聚焦专题>>增值业务套餐分析>>内容订购推荐</font></td><td><a href='javascript:;' onclick="open_metaExplain('SUBJECT')"><img src="<%=request.getContextPath()%>/biimages/home/nav_icon3.gif" width="14" height="14" border="0" hspace="10">指标说明</a></td>
      ...
      <tr> 
        ...
        <table width="100%" border="0">
          <tr>
			  ...
			  &nbsp;&nbsp;资费名称:<BIBM:TagSelectList listName="qry__dim3"
									focusID="<%=qryStruct.dim3%>" listID="0"
									selfSQL="select lvl_name,remark from d_adv_param_lvl where param_id=107 order by lvl_id" />
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr>	
		<td align="center" colspan="2"><iframe id="table_product_t_001" width="100%"
			height="430"
			src="SubjectCommTable.rptdo?table_id=add_macro_007&first=Y&table_height=425"
...
<table cellspacing="0" cellpaddingx="0" style="width: 100%;">
		...
		<tr>
		<td><%=CommTool.getEditorHtml("contentComm","0")%></td>
	</tr>
</table>
