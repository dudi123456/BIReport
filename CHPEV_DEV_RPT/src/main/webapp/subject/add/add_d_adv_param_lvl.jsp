...
function _newParam(){	
    ...
    TableQryForm.action="addSubjectParam.rptdo?optype=add_param_lvl";
	TableQryForm.submit();
}
...
function _editParam(){	
    ...
    TableQryForm.action="addSubjectParam.rptdo?optype=edt_param_lvl";
	TableQryForm.submit();
}
...
function _delParam(){	
	...
	if(confirm("确认要删除吗？")){
		TableQryForm.action="addSubjectParam.rptdo?optype=del_param_lvl";
		TableQryForm.submit();
	}
}
...
<FORM name="TableQryForm" action="addSubjectParam.rptdo?optype=qry_d_adv_param_lvl"  method="post">
<Tag:Bar />
