...
var addTypeLen = 0;
var tableId = "MIFO001";
var title = new Array("订购率分析","分布分析","累计值","累计值同比");
var tabName = new Array("订购率分析","分布分析");
...
function changeSrc1(rdo){
	//alert(rdo);
	var iframe = document.getElementById("table_add_macro_004_2");
	tableId = "add_macro_004_2";
...
//	linkDiv.innerHTML=sHtml;
	//alert(tab);
	document.getElementById("feeTab").innerHTML="<font class='tooltitle'>专题分析>>增值聚焦专题>>增值业务套餐分析>>流量套餐>>"+tabName[parseInt(tab)-1]+"</font>";
...
function seleType1(id,name,ck) {
	...
	chartIframe = document.getElementById("chart_add_macro_004_2_C_1");
	chartIframe.src="SubjectCommChart.screen?chart_id=add_macro_004_2_C_1&first=Y";


	chartIframe = document.getElementById("chart_add_macro_004_2_C_2");
	chartIframe.src="SubjectCommChart.screen?chart_id=add_macro_004_2_C_2&first=Y";
...
function checkAllItem(opValue){
	...
	if (opValue==0)
	{
		strHref = "<input type='button' onclick='checkAllItem(1);' style='font-weight:bold' value='全选'>&nbsp;&nbsp;";
	}else if(opValue==1){

		strHref = "<input type='button' onclick='checkAllItem(0);' style='font-weight:bold' value='全不选'>&nbsp;&nbsp;";
	}
...
function seleType2(id,name,ck) {
	...
	for(var i=0; i<radio.length; i++) {
		...
		if (radio[i].checked)
		{
				var iframe = document.getElementById("table_add_macro_004_1");

				iframe.src="SubjectCommTable.rptdo?table_id="+radio[i].value+"&first=Y&table_height=300";

				var chartIframe = document.getElementById("chart_add_macro_004_C_1");
...
<table style="width: 100%; margin-top: 0px;" cellspacing="0" cellpadding="0">
	<tr>
		<td  style="padding-left:3px;border-bottom:1px #b3cddd solid;">
			<a id="menu_1" class="tab_short" href="javascript:void(0)" onclick="menuChanger(1,2);changeSrc1('1')" style='font-weight:bold'>订购率分析</a><a id="menu_2" class="tab_short" href="javascript:void(0)" onclick="menuChanger(2,2);changeSrc2('1')" style='font-weight:bold'>分布分析</a>
		</td>
	</tr>
</table>
...
<table style="width: 100%;font-weight:bold" align="center" cellspacing="0" cellpadding="0">
    ...
    <div id="menucontent"
         style="position:absolute;width:650px;height:5px;left:<%=screenx-900%>px;top:10px;padding-top:10px;overflow:hidden;">
<table class="popwidow" cellpadding="0" cellspacing="5">
	<tr>
		<td class="poptitle" style="width:600px">资费名称</td>

		<td class="poptitle" style="width:90px">时间</td>
		<td class="poptitle" style="width:40px">操作</td>
	</tr>
	<tr>
			<td valign="top"><%=PageConditionUtil.getPrice_plan_Desc(request,qryStruct.price_plan_id,"price_plan_id","price_plan_desc",2,2)%></td>
...
<table style="width: 100%; display: none;"  id="content_1" cellspacing="0" cellpaddingx="0">
	<tr  valign="top" id="add_type_1" >
		...
		<tr  valign="top">
			...
			<td align="left" valign="top" ><iframe id="chart_add_macro_004_2_C_1"
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>

							<td align="left" valign="top" ><iframe id="chart_add_macro_004_2_C_2"
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>
		...
		<tr  valign="top" id="add_type_1" >
			...
			<span id="choseArea">
			<input type='button' onclick="checkAllItem('0');" style='font-weight:bold' value="全不选">&nbsp;&nbsp;</span>
			</td>

			<td>
			<%
			String[][] res1 = CommTool.queryZiFeeInfo("2");
	...
	<td>
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">
			...
			<tr valign="top" >
				<td align="left" colspan="2"><iframe name="table_add_macro_004_2" id="table_add_macro_004_2" width="100%" height="220"
							src=""
...
<table style="width: 100%; display: none;" id="content_2" cellspacing="0" cellpadding="0">
	<tr  valign="top" id="add_type_2" >
		...
		<tr  valign="top">
			   <td class="toolbg" colspan=2>
			 		<INPUT class="radioStyle" onclick="changeChart('add_macro_004_1','add_macro_004_1_C_1','1');" value="add_macro_004_1" type=radio name=Leve6_1 checked>按ARPU分档
			 		<INPUT class="radioStyle" onclick="changeChart('add_macro_004_1_2','add_macro_004_1_2_C_1','2');" value="add_macro_004_1_2" type=radio name=Leve6_1>按在网时长分档
			 		<INPUT class="radioStyle" onclick="changeChart('add_macro_004_1_3','add_macro_004_1_3_C_1','3');" value="opp_macro_001_2_C_4" type=radio name=Leve6_1>饱和度分档
			...
			<tr valign="top">
					<td align="left" valign="top" ><iframe id="chart_add_macro_004_C_1"
						scrolling="no" width="100%" height="220" border="0" frameborder="0"
						marginwidth="0" marginheight="0" src=""></iframe></td>
	...
	<td>
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">
			...
			<tr valign="top" >
				<td align="left" colspan="2"><iframe id="table_add_macro_004_1" width="100%" height="220"
							src=""
					frameborder="0" scrolling="no"></iframe>
				</td>
			</tr>
...
<table cellspacing="0" cellpaddingx="0" style="width: 100%;">
		...
		<tr>
		<td><%=CommTool.getEditorHtml("add_shortmsgflow_analyse","0")%></td>
	</tr>
</table>
