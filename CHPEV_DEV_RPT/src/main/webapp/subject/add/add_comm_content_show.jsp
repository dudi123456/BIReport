...
<FORM name="TableQryForm" action="addSubjectExp.rptdo?opType=qry_AgainConComm"  method="post">
<%=WebPageTool.pageScript("TableQryForm","Show_AddContentComm.screen")%>
<% 
        ...
        <table width="100%" border="0">
          <tr>
			  ...
			  <td>ARPU分档:<BIBM:TagSelectList listName="qry__dim10"
				...
				<tr>
				 <td>在网时长分档:<BIBM:TagSelectList listName="qry__dim4"
