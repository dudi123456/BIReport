...
<script>
	...
	function initframe(){					
		...
		if(ctl_lvl=="0"){//总部	
			tableIframe.src="SubjectCommTable.rptdo?table_id=SOC_CHANNL_GEN_P_T&first=Y&table_height=365";	
		}else if(ctl_lvl=="1"){//省分	
			tableIframe.src="SubjectCommTable.rptdo?table_id=SOC_CHANNL_PROV_P_T&first=Y&table_height=365";
		}else if(ctl_lvl=="2"){//地市
			tableIframe.src="SubjectCommTable.rptdo?table_id=SOC_CHANNL_CITY_P_T&first=Y&table_height=365";
		}		
	}
