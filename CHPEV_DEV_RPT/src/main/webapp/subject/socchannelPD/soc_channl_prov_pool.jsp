...
<script>
	...
	function initframe(){					
		...
		//}else if(ctl_lvl=="1"){//省分	
			tableIframe.src="SubjectCommTable.rptdo?table_id=SOC_CHANNL_PROV_P_T&first=Y&table_height=550";
		//}else if(ctl_lvl=="2"){//地市
			//tableIframe.src="SubjectCommTable.rptdo?table_id=SOC_CHANNL_CITY_P_T&first=Y&table_height=250";
		//}		
	}
	...
	*/
	...
	<INPUT type=hidden id="oriDate" name="qry__rpt_date"  value="<%=qryStruct.rpt_date%>">
		...
		<!-- 查询条件区,开始 -->
		<div class="topsearch">
			<table width="55%" border=0 cellpadding="0" align="center" cellspacing="0">
				<tr>
