...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="validateBottom">
        <tr>
          <td width="15%" class="validatebox-tabTD-left">策略名称：</td>
          <td width="30%" class="validatebox-tabTD-right"><input value="<%=qryStruct.tactic_name%>" id="qry__tacticName" name="qry__tacticName"></td>
          <td width="15%" class="validatebox-tabTD-left">策略类型：</td>
          <td width="30%" class="validatebox-tabTD-right">
          <BIBM:TagSelectList  focusID="<%=qryStruct.tactic_type%>" allFlag=""	listName="qry__tactic_type" listID="0" selfSQL="<%=tactictypeSql%>" />
          </td>
