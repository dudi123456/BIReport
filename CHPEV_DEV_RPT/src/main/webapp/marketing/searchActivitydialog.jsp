...
<%
String isDialog = (String)request.getAttribute("isDialog");
...
function doSearch()
{
 	...
 	form1.action="activityAction.rptdo?optype=searchActivitydialog&doType=search&qry__activity_state=2&isDialog=<%=isDialog%>";
 	form1.submit();
}
</script>
</head>
