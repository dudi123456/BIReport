...
<input type="hidden" value="<%=pinfo.getProjectId() %>" id="object_id" name="object_id">
<input type="hidden" value="projectPassList" id="optype" name="optype">
<input type="hidden" value="project" id="doType" name="doType">
<input type="hidden" value="project" id="state" name="state">
<input type="hidden" value="project" id="advice" name="advice">
   <div class="validatebox-tabTD-title">方案审批列表</div>
<%
	if(null!=pinfo){
		if(0==pinfo.getState()){
%>
...
<%
	...
	%>
				<%
				if(1==pinfo.getState()&&loginUser.user_id.equals(pinfo.getWarnName()) ){
						%>
