...
<%
	...
	List<ContactPlyInfo> list1 =(List<ContactPlyInfo>) session.getAttribute("ContactPlyInfoList");
...
function mySave(){
	form1.action="tacticAction.rptdo?optype=tacticList&doType=save";
	form1.submit();
}
function add(){
...
<div class="validatebox-tabTD-title">营销策略信息维护:当前是第四步(营维手段配置)/共四步</div>
...
<div class="list_content">
          <table >
            <tr width="100%">
              ...
              <th width="15%" align="center"> 序         号</th>
              <th width="15%" align="center"> 营维手段名称 </th>
              <th width="20%" align="center"> 营维手段描述 </th>
        ...
        <br>
          <input type="button" class="public-btn2" onclick="add()" value="添加营维手段"/>
            <input type="button" class="public-btn2" onclick="myDelete()" value="删除营维手段" />
             <input type="button" class="public-btn2" onclick="mySelect()" value="选择资源"/>
<!-- 营销规则结束 -->
          </td>
        </tr>
</table>
<div class="buttonArea">
    ...
    <button class="btn4" type="button" onClick="mySave()"> 保存</button>
