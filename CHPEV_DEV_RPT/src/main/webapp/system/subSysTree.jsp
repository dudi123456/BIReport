...
%>
function pageRedirect_id(systemId) {
	var iframe = document.getElementById("systemlist_frame");
	iframe.src="system.rptdo?system_id="+systemId;
}
</script>
</head>
...
var tree = new WebFXLoadTree("子系统","createSystemTreeXML.rptdo");
document.write(tree);
