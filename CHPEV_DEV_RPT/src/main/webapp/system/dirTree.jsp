...
<script type="text/javascript" src="common/dtreeDir.js"></script>
<script>
...
d.add(0,-1,'目录','','test','work_frame');
<%
  for(int i=0;rs != null && i<rs.length;i++) {
	  out.print("d.add("+rs[i][0]+","+rs[i][1]+",'"+rs[i][2]+"','dirView.jsp?submitType=1&favor_id=" + rs[i][0] + "','test','work_frame');\n");
