...
qryStruct.dim1 = request.getParameter("log_oper_no");
%>
...
<table style="width: 100%;"  id="content_1" cellspacing="0" cellpaddingx="0">
	...
	<td >
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">			
			<tr valign="top" >
				<td align="left" colspan="2"><iframe name="table_login_rank_02" id="table_login_rank_02" width="100%" height="300"
							src="SubjectCommTable.rptdo?table_id=login_rank_02&first=Y&table_height=300"
