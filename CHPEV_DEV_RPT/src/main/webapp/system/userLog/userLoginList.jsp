...
<script lanaguage="javascript">
	...
	{
		document.form1.action="userLogStat.rptdo?opType=logindetail&userid=" + userid;
...
<form name="form1" action="userLogStat.rptdo?opType=loginstat" method="post">
<%=WebPageTool.pageScript("form1","loginstatic.screen")%>
<%
...
<table style="width: 99%;" align="center" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="toolbg">起始日期:
            ...
            <input type="text" size="10" name="userName" class="coolText" id="userName" value="<%=qryStruct.dim4%>">
...
<table style="width: 99%;" height="100%" align="center">
	<tr>
		...
		<table style="width: 100%">
			<tr>
				<td class="titlebg2" width="151"><font class="title1">登录日志分析</font></td>
  ...
  %>
						...
						<tr class="celdata" onmouseover="this.className='mouseM'" onmouseout="this.className='celdata'">
							...
							<td><%=value[2]%></td>
							<td><%=value[3]%></td>
							<td><%=FormatUtil.formatStr(value[4],2,true)%></td>
							<td class="centerdata"><a href="javascript:;" onclick="javascript:viewLogDetail('<%=value[0]%>')">用户登录情况分析</a></td>
						</tr>
						 <%} %>
  <%} %>
