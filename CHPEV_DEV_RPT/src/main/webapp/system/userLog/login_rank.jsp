	...
	<tr>
		...
		<tr>
			<td class="toolbg">起始日期:
				...
				登录名:<input type="text" size="10" id="userId" name="qry__oper_no" value="<%=qryStruct.oper_no%>">
	                                        用户名:<input type="text" size="10" id="userName" name="qry__user_id" value="<%=qryStruct.user_id%>">
				<input type="submit" id="button_submit" value="查询" onclick="checkInfo()">
				<input type="button" id="button_reset" value="重置" onclick="resetValue()"></td>
			<td class="toolbg" align="right"></td>
		</tr>
	</tr>
</table>
<table style="width: 100%;"  id="content_1" cellspacing="0" cellpaddingx="0">
	...
	<td >
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">
			<tr valign="top" >
				<td align="left" colspan="2"><iframe name="table_login_rank_01" id="table_login_rank_01" width="100%" height="300"
							src="SubjectCommTable.rptdo?table_id=login_rank_01&first=Y&table_height=300"
	...
	<td>
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">
			<tr valign="top" >
				<td align="left" colspan="2"><iframe id="chart_login_rank_01_C_1"
						scrolling="no" width="100%" height="250" frameborder="0"
						marginwidth="0" marginheight="0" src="SubjectCommChart.screen?chart_id=login_rank_01_C_1&flag=Y"></iframe></td>
				</td>
			</tr>
		</table>
	</td>
