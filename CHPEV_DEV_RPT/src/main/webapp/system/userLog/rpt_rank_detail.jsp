...
qryStruct.dim1 = request.getParameter("obj_id");
%>
...
<tr>
<td width="151"><font class="title1"><%=request.getParameter("obj_name") %></font></td>
</tr>
</table>
<table style="width: 100%;"  id="content_1" cellspacing="0" cellpaddingx="0">
	...
	<td >
		<table  cellspacing="0" cellpaddingx="0" style="width: 100%;">			
			<tr valign="top" >
				<td align="left" colspan="2"><iframe name="table_rpt_rank_02" id="table_rpt_rank_02" width="100%" height="300"
							src="SubjectCommTable.rptdo?table_id=rpt_rank_02&first=Y&table_height=300"
