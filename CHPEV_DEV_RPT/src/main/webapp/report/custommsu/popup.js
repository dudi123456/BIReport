  ...
  function popmsg(title,content,contextPath){
    ...
    strHTML += '<tr>\n';
    strHTML += '<td width="7">';
    strHTML += '<img src="'+contextPath+'/images/ts/tab_corner_1.gif" ';
    strHTML += 'width="7" height="22"></td>';
    strHTML += '<td width="20" valign="bottom" ';
    strHTML += 'background="'+contextPath+'/images/ts/tab_corner_bg.gif">';
    strHTML += '<img src="'+contextPath+'/images/info.gif" width="14" height="16"></td>';
    strHTML += '<td width="100%" align="center" ';
    strHTML += 'valign="bottom" background="'+contextPath+'/images/ts/tab_corner_bg.gif" ';
    strHTML += 'style="padding:3px 0px 0px 5px;font-size:12px;color:#4D575E;">';
    strHTML += '<B>'+title+'</B></td>';
    strHTML += '<td width="96" background="'+contextPath+'/images/ts/tab_corner_bg.gif">';
    strHTML += '<a href=\"#\" onClick="parent.hiddenWin();">';
    strHTML += '<img src="'+contextPath+'/images/info_close.gif" width="13" ';
    strHTML += 'height="13" border="0"></a></td>';
    strHTML += '<td width="10" align="right" ';
    strHTML += 'background="'+contextPath+'/images/ts/tab_corner_bg.gif">';
    strHTML += '<img src="'+contextPath+'/images/ts/tab_corner_5.gif" ';
    strHTML += 'width="7" height="22"></td>';
    strHTML += '</tr>';
    strHTML += '<tr>';
