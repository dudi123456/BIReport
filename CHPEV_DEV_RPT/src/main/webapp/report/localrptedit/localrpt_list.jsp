...
<form NAME="frmEdit" ID="frmEdit" ACTION="ReportListView.rptdo?opType=listLocalRpt" method="post">
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="1" class="table-bg">
  ...
  <tr class="table-white-bg">
    ...
    <td nowrap><%=rptTables[i].local_res_code%></td>
