...
<form NAME="frmEdit" ID="frmEdit" ACTION="ReportListView.rptdo?opType=listAttstationRpt" method="post">
      ...
      <tr> 
        ...
        <table width="100%" border="0">
          <tr>
			...
			<td nowrap><input type="text" size="20" name="qry__rpt_name"></td>
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="1" class="table-bg">
  <tr align="center">
    ...
    <td class="tab-title">制表人</td>
    <td class="tab-title">需求提出人</td>
    <td class="tab-title">操作</td>
  </tr>
  <%if(rptTables==null||rptTables.length==0){ %>
  <tr class="table-white-bg">
    <td colspan="8" nowrap align="center">该条件下没有符合要求的数据</td>
  </tr>
  <%}else{ %>
  ...
  <tr class="table-white-bg">
    ...
    <td nowrap><%=rptTables[i].makeperson %></td>
    <td nowrap><%=rptTables[i].needperson %></td>
    <td nowrap align="center"><a href="editLocalReport.rptdo?opType=attstation&rpt_id=<%=rptTables[i].rpt_id %>">认证</a></td>
  </tr>
  <%} %>
  <%} %>
</TABLE>
