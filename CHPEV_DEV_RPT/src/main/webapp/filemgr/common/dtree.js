...
dTree.prototype.toString = function() {
	...
	if (document.getElementById) {
		...
		{
			if(this.getSelected() == null || this.getSelected().indexOf("&")<0)
				this.selectedNode = this.getSelected();
			else 
				this.selectedNode = this.getSelected().substring(0,this.getSelected().indexOf("&"));
		}
...
//		if (node.title) str += ' title="' + node.title + '"';
		...
		if (this.config.useSelection && ((node._hc && this.config.folderLinks) || !node._hc))
			str += ' onclick="javascript: ' + this.obj + '.s(' + nodeId + ');clickNode('+node.id+',\'s'+this.obj + nodeId + '\');" ondblclick="onModify()"';
		str += '>';
	}
...
/*		if (this.selectedNode || this.selectedNode==0) {
		...
		if (this.config.useCookies) this.setCookie('cs' + this.obj, cn.id+"&"+"s" + this.obj + id);
	}
};
...
//		alert("cookiename:"+cookieName+"&"+cookieValue)
	document.cookie =
