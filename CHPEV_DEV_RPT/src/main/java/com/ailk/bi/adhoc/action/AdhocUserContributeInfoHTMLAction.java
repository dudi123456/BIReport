...
public class AdhocUserContributeInfoHTMLAction extends HTMLActionSupport {
	...
	public void doTrans(HttpServletRequest request, HttpServletResponse response)
		...
		UiAdhocUserContribute contributeInfo = userService
				.getUserContributeInfo(userNo, gatherMon);
		session.setAttribute(AdhocConstant.ADHOC_USER_CONTRIBUTE_INFO,
				contributeInfo);
		// 转向JSP页面
		setNextScreen(request, "AdhocUserContribute.screen");
	}
}
